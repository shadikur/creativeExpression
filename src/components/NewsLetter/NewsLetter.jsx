...
const NewsLetter = () => {
    return (
        <div>
            <section className="relative py-10 overflow-hidden bg-black sm:py-16 lg:py-24 xl:py-32 rounded-2xl mb-5">
                <div className="absolute inset-0">
                    <img
                        className="object-cover w-full h-full md:object-left md:scale-150 md:origin-top-left"
                        src="https://vpa.uncg.edu/wp-content/uploads/2020/12/Igoe11-1164x526.jpeg"
                        alt=""
                    />
                </div>
                ...
                <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left">
                        ...
                        <p className="mt-4 text-base text-gray-200">
                            Sign up for our newsletter to receive updates on new classes, instructors, and more!
                        </p>
